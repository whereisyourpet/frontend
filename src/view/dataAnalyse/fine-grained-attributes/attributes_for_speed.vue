...
<script>
import type from "../content/speed/type";
import gender from "../content/speed/gender";
import MaturitySize from "../content/speed/MaturitySize";
import Quantity from "../content/speed/Quantity";
