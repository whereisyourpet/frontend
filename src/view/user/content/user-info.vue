...
export default {
  ...
  mounted() {
    ...
    this.$axios(setting).then(response => {
      ...
      if (response.data.has_pet == true) me.data.has_pet = "1";
      else me.data.has_pet = "2";
      if (response.data.willing == true) me.data.willing = "1";
      else me.data.willing = "2";
      if (response.data.married == true) me.data.married = "1";
      else me.data.married = "2";
      if (response.data.gender == true) me.data.gender = "1";
      else me.data.gender = "2";
  ...
  methods: {
    handle_modify() {
      ...
      this.$axios.defaults.withCredentials = true;
      this.$axios
        .post("http://127.0.0.1:8000/users/modify", postData)
